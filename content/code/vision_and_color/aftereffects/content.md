...
images:
  - link: "motion_v1.webp"
    title: "[Adapting Environment - Example 1](#observations-from-the-motion-examples)"
  - link: "motion_v2.webp"
    title: "[Test (Static Pattern) - Example 1](#observations-from-the-motion-examples)"
  - link: "https://www.youtube.com/embed/0G0rXqvwR0Q"
    title: "[Animated version - Example 1](#observations-from-the-motion-examples)"
  - link: "motion_h1.webp"
    title: "[Adapting Environment - Example 2](#observations-from-the-motion-examples)"
    description: "Horizontal motion, noise sequence"
  - link: "motion_h2.webp"
    title: "[Test (Static Pattern) - Example 2](#observations-from-the-motion-examples)"
    description: "Horizontal motion, noise sequence"
  - link: "https://www.youtube.com/embed/ToXalRJiq8E"
    title: "[Animated version - Example 2](#observations-from-the-motion-examples)"
  - link: "motion_hn1.webp"
    title: "[Adapting Environment - Example 3](#observations-from-the-motion-examples)"
  - link: "motion_hn2.webp"
    title: "[Test (Static Pattern) - Example 3](#observations-from-the-motion-examples)"
  - link: "https://www.youtube.com/embed/LLtaVCUmltE"
    title: "[Animated version - Example 3](#observations-from-the-motion-examples)"
  - link: "albers_small.webp"
    title: "[Adapting Environment - Example 1](#observations-from-the-color-examples)"
  - link: "albers2.webp"
    title: "[Test (strictly stationary hue) - Example 1](#observations-from-the-color-examples)"
  - link: "https://youtube.com/embed/WBCzhokJfyA"
    title: "Animated version - Example 1"
  - link: "filter1.webp"
    title: "[Adapting Environment - Example 2](#observations-from-the-color-examples)"
  - link: "filter2.webp"
    title: "[Test (average hue is stationary) - Example 2](#observations-from-the-color-examples)"
  - link: "https://youtube.com/embed/GeylNFVX66Y"
    title: "[Animated version - Example 2](#observations-from-the-color-examples)"
  - link: "ladrillos1.webp"
    title: "[Adapting Environment - Example 3](#observations-from-the-color-examples)"
  - link: "ladrillos2.webp"
    title: "[Test (stationary hue) - Example 3](#observations-from-the-color-examples)"
  - link: "https://youtube.com/embed/E5040GE6Wig"
    title: "[Animated version - Example 3](#observations-from-the-color-examples)"
  - link: "param_h1.webp"
    title: "[Adapting Environment - Example 1.1](#observations-from-the-texture-examples)"
  - link: "param_h4.webp"
    title: "[Test Tests (stationary contrast) - Example 1.1](#observations-from-the-texture-examples)"
  - link: "https://youtube.com/embed/fHRBGlN9B00"
    title: "[Animated version - Example 1.1](#observations-from-the-texture-examples)"
  - link: "param_h2.webp"
    title: "[Adapting Environment - Example 1.2](#observations-from-the-texture-examples)"
  - link: "param_h4.webp"
    title: "[Test Tests (stationary contrast) - Example 1.2](#observations-from-the-texture-examples)"
  - link: "https://youtube.com/embed/MJkYUA-55TI"
    title: "[Animated version - Example 1.2](#observations-from-the-texture-examples)"
  - link: "param_h3.webp"
    title: "[Adapting Environment - Example 1.3](#observations-from-the-texture-examples)"
  - link: "param_h4.webp"
    title: "[Test Tests (stationary contrast) - Example 1.3](#observations-from-the-texture-examples)"
  - link: "https://youtube.com/embed/h4yDSrxo3Gk"
    title: "[Animated version - Example 1.3](#observations-from-the-texture-examples)"
  - link: "pca_h1.webp"
    title: "[Adapting Environment - Example 2.1](#observations-from-the-texture-examples)"
  - link: "pca_h4.webp"
    title: "[Test Tests (stationary contrast) - Example 2.1](#observations-from-the-texture-examples)"
  - link: "https://youtube.com/embed/f04qjmeH-74"
    title: "[Animated version - Example 2.1](#observations-from-the-texture-examples)"
  - link: "pca_h2.webp"
    title: "[Adapting Environment - Example 2.2](#observations-from-the-texture-examples)"
  - link: "pca_h4.webp"
    title: "[Test Tests (stationary contrast) - Example 2.2](#observations-from-the-texture-examples)"
  - link: "https://youtube.com/embed/Df1aSgwPQ_w"
    title: "[Animated version - Example 2.2](#observations-from-the-texture-examples)"
  - link: "pca_h3.webp"
    title: "[Adapting Environment - Example 2.3](#observations-from-the-texture-examples)"
  - link: "pca_h4.webp"
    title: "[Test Tests (stationary contrast) - Example 2.3](#observations-from-the-texture-examples)"
  - link: "https://youtube.com/embed/fTbmvfUqCGI"
    title: "[Animated version - Example 2.3](#observations-from-the-texture-examples)"
  - link: "SPCA_concept.webp"
    title: "[Identification of curvilinear coordinates and multidimensional histogram equalization using SPCA](#predictions-using-sequential-principal-curves-analysis)"
    description: "Left panel represents the data and coordinates at the input domain, and the right panel represents the data and coordinates at the SPCA transformed domain. Gray regions represent the underlying data distribution or PDF, and the lines in bold style represent the projections of the highlighted sample **x** onto the first, second, and third Principal Curves. Using SPCA with information maximization criterion this implies histogram uniformization (see section 4 of the [Paper](https://huggingface.co/datasets/isp-uv-es/Web_site_legacy/resolve/main/data/frontiers_laparra_malo_Accepted_15.pdf) for more details and the [Technical Report](https://huggingface.co/datasets/isp-uv-es/Web_site_legacy/resolve/main/data/IPL_TR_PCs.pdf) for full details). This means transforming the nonuniform curvilinear coordinates into a cartesian grid."
  - link: "gral_contrast.webp"
    title: "[Adaptation of texture sensors I](#predictions-using-sequential-principal-curves-analysis)"
    description: "Different directions in the image space represent the presence of certain elementary patterns of bigger and bigger amplitude (or contrast). Bigger and bigger stimulation of a linear sensor tuned to certain pattern implies moving along a certain line. If the sensor is nonlinear this means moving in nonuniform steps or along a curve. If this stimulation is done in different environments (i.e. on top of different backgrounds), it can be seen as equivalent departures from different points of the space. Different points of the space can also be seen as different stimulation in sensors tuned to similar or disimilar patterns. The figure below illustrates this concept: the same stimulation along the green curve/dimension at different locations along the red curve (different environments).  In this case, the frequency of the background is similar to the frequency preferred by the considered sensor (severe masking situation). Different environments defined as different locations in the linear representation space is the key concept in the motion and texture experiments (figures 4 and 7 of the [Paper](https://huggingface.co/datasets/isp-uv-es/Web_site_legacy/resolve/main/data/frontiers_laparra_malo_Accepted_15.pdf))."
  - link: "spca_contrast.webp"
    title: "[Adaptation of texture sensors II](#predictions-using-sequential-principal-curves-analysis)"
    description: "Equalization of the image manifold implies different deformations in different points of the space. This implies that responses to the same Euclidean departures in different environments lead to different lengths along the principal curves (the responses of SPCA sensors). (a) equivalent stimulations in different backgrounds in the input domain, (b) SPCA transform. (c) Associated responses (length along the green principal curve in each case). This leads to a reduction in response/visibility in environment 2 with regard to environment 1. Figure 12 in the [Paper](https://huggingface.co/datasets/isp-uv-es/Web_site_legacy/resolve/main/data/frontiers_laparra_malo_Accepted_15.pdf) shows that transform from (a) to (b) is the actual behavior of SPCA on texture samples."
  - link: "gral_color.webp"
    title: "[Adaptation of color sensors I](#predictions-using-sequential-principal-curves-analysis)"
    description: "Different spectral illumination implies a general change of orientation of the data manifold. This change is not always linear [Laparra12]. Similar changes in the manifold arise when reflectance of the environment is biased in some way (e.g. mainly yellowish/reddish objects). In the example below the blue and orange regions represent the color data manifolds in D65 and A illuminations which basically differ in a rotation around the origin towards the yellow end of the Blue-Yellow (BY) direction (shift along the blue curve). What is the perceived hue of a fixed sample (e.g. the sample represented by the open circle) in these different environments?"
  - link: "spca_color.webp"
    title: "[Adaptation of color sensors II](#predictions-using-sequential-principal-curves-analysis)"
    description: "Equalization of the color manifold implies (i) different deformations in different points of the space, and (ii) shifts of what is considered to be the origin of the space. This implies (i) nonlinear responses, and (ii) the response to certain stimulus is interpreted in different way. For instance responses of an opponent mechanism may change from positive to negative hence totally changing the judgement of hue. (a) color data in the input (tristimulus) domain. (b) and (c) SPCA transformed data equalizing the environment 1 or environment 2 manifolds. Note that the highlighted sample (open circle) falls on opposite regions of the space. (d) canonical representation. (e) Associated response in the considered environments. "
  - link: "results_motion.webp"
    title: "[Predictions of nonlinear responses leading to the Motion Aftereffect](#predictions-of-nonlinear-responses-leading-to-the-motion-aftereffect)"
  - link: "results_texture.webp"
    title: "[Predictions of nonlinear responses leading to the Texture Aftereffect](#predictions-of-nonlinear-responses-leading-to-the-texture-aftereffect)"
  - link: "D_info.webp"
    title: "[Infomax: Predictions of nonlinear responses leading to the Color Aftereffect](#predictions-of-nonlinear-responses-leading-to-the-color-aftereffect)"
  - link: "https://youtube.com/embed/R4bkEGH7RSY"
    title: "[VQEG database](#natural-movies)"
  - link: "https://youtube.com/embed/VQXu5oLneuY"
    title: "[LIVE database](#natural-movies)"
  - link: "https://youtube.com/embed/o-dcUSVC9jw"
    title: "[PCA functions of natural video](#natural-movies)"
  - link: "mcgill.webp"
    title: "[Sample Images](#natural-images)"
  - link: "basis.webp"
    title: "[First PCA basis functions](#natural-images)"
  - link: "data_set_d65.webp"
    title: "[CIE D65 illuminant](#natural-colors)"
  - link: "data_set_d65.webp"
    title: "[CIE A illuminant](#natural-colors)"

references:
  - title: "Visual Aftereffects and Sensory Nonlinearities from a Single Statistical Framework"
    authors: "V. Laparra, J. Malo"
    publication: "Frontiers in Human Neuroscience. Special Issue on Perceptual Illusions. 2015"
    link: "https://huggingface.co/datasets/isp-uv-es/Web_site_legacy/resolve/main/data/frontiers_laparra_malo_Accepted_15.pdf"
  - title: "The full report on Sequential Principal Curves Analysis"
    authors: "V. Laparra, J. Malo"
    publication: "IPL-Technical Report. Universitat de València. 2015"
    link: "https://huggingface.co/datasets/isp-uv-es/Web_site_legacy/resolve/main/data/IPL_TR_PCs.pdf"
  - title: "V1 non-linear properties emerge from local-to-global non-linear ICA"
    authors: "J. Malo, J. Gutiérrez"
    publication: "Network: Comp. Neural Systems. 2006"
  - title: "Nonlinearities and Adaptation of Color Vision from Sequential Principal Curves Analysis"
    ...
    publication: "Neural Computation, vol. 24, no. 10, pp. 2751–2788, 2012"
  - title: "Principal Polynomial Analysis (PPA)"
    authors: "V. Laparra, S. Jimenez, D. Tuia, G. Camps-Valls, J. Malo"
    publication: "International Journal of Neural Systems, 24(7) Nov. 2014"
    link: "https://huggingface.co/datasets/isp-uv-es/Web_site_legacy/resolve/main/data/IJNS_Laparra14_accepted_v5.pdf"
  ...
  - title: "The relation between color discrimination and color constancy: When is optimal adaptation task dependent?"
    authors: "Abrams, A., Hillis, J., Brainard, D."
    publication: "Neural Computation, 19(10):2610–2637, 2007"
  - title: "Possible principles underlaying the transformation of sensory messages"
    authors: "Barlow, H."
    publication: "Sensory Communication, pp. 217-234, 1961"
  - title: "A theory about the functional role and synaptic mechanism of visual aftereffects"
    authors: "Barlow, H."
    publication: "Vision: Coding and Efficiency, C. Blakemore, Ed. Cambridge Univ. Press, 1990"
  - title: "Redundancy reduction revisited"
    authors: "Barlow, H."
    publication: "Network: Computation in Neural Systems, 2001"
  - title: "On the existence of neurons in the human visual system selectivity sensitive to the orientation and size of retinal   images"
    authors: "Blakemore C., Campbell F.W."
    publication: "J. Physiol. 203: 237-60, 1969"
  - title: "Normalization as a canonical neural computation"
    authors: "Carandini M., Heeger D."
    publication: "Nature Reviews. Neurosci., vol. 13, no. 1, pp. 51–62, 2012"
  - title: "Visual adaptation: Neural, psychological and computational aspects"
    authors: "Clifford, C., Webster, M., Stanley, G., Stocker, A., Kohn, A., Sharpee, T., Schwartz, O."
    publication: "Vision Research, vol. 47, pp. 3125–3131, 2007"
  - title: "A functional angle on some after-effects in cortical vision"
    authors: "Clifford, C., Wenderoth, P., Spehar, B."
    publication: "Proc. Roy. Soc. B, 267, 1705–1710, 2000"
  - title: "Perceptual adaptation: motion parallels orientation"
    authors: "Clifford, C."
    publication: "Trends Cog. Sci. 6(3): 136-143, 2002"
  - title: "Statistical models of linear and nonlinear contextual interactions in early visual processing"
    authors: "Coen-Cagli, R., Dayan, P., Schwartz, O."
    publication: "Adv. Neur. Inf. Proc. Syst. NIPS 09'. vol. 22, 369–377, 2010"
  - title: "Color Appearance Models"
    authors: "Fairchild, M."
    publication: "2nd Ed. Chichester, UK: Wiley-IS&T, 2005"
  - title: "Spatio-chromatic adaptation via Higher-Order Canonical Correlation Analysis"
    authors: "Gutmann, M., Laparra, V., Hyvarinen, A., Malo, J."
    publication: "PLoS ONE, 2014"
    link: "https://huggingface.co/datasets/isp-uv-es/Web_site_legacy/resolve/main/data/Gutmann_Laparra_Hyvarinen_Malo_PLOS_14.pdf"
  - title: "Color discrimination and adaption"
    authors: "Krauskopf, J., Gegenfurtner, K."
    publication: "Vision Res., 32, 11, 2165–2175, 1992"
  - title: "The motion after-effect reloaded"
    authors: "Mather G., Pavan A., Campana G., Casco C."
    publication: "Trends Cog. Sci. 12(12): 481-487, 2008"
  - title: "Predicting the motion after-effect from sensitivity loss"
    authors: "Morgan, M., Chubb, C., Solomon, J."
    publication: "Vision Research, 46, 2412–2420, 2006"
  - title: "A model of neuronal reponses in visual area MT"
    authors: "Simoncelli, E., Heeger, D."
    publication: "Vision Research, 38, 5, 743–761, 1998"
  - title: "Sensory adaptation within a Bayesian framework for perception"
    authors: "Stocker, A. A., Simoncelli, E. P."
    publication: "Adv. Neur. Inf. Proc. Syst. (NIPS 05'), vol. 18, 1291–1298, 2006"
  - title: "Visual motion aftereffects arise from a casacade of two isomorphic adaptation algorithms"
    authors: "Stocker, A., Simoncelli, E."
    publication: "Journal of Vision, 9, 2009"
  - title: "A model of visual contrast gain control and pattern masking"
    authors: "Watson A.B., Solomon J."
    publication: "JOSA A, vol. 14, pp. 2379–2391, 1997"
  - title: "Motion illusions as optimal percepts"
    authors: "Weiss, Y., Simoncelli, E. P., Adelson, E. H."
    publication: "Nature Neuroscience, 3, 598–604, 2002"
---
